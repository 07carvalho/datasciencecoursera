# makeCacheMatrix is awesome. It creates a list containing a function to:
...
# cacheSolve is awesome too! It is a function that returns the inverse of the matrix.
